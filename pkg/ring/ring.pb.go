...
type InstanceDesc struct {
	...
	GeneratedTokens     uint32 `protobuf:"varint,9,opt,name=generated_tokens,json=generatedTokens,proto3" json:"generated_tokens,omitempty"`
}
...
func (m *InstanceDesc) GetGeneratedTokens() uint32 {
	if m != nil {
...
var fileDescriptor_26381ed67e202a6e = []byte{
	...
	,
}
...
func (this *InstanceDesc) Equal(that interface{}) bool {
	...
	if this.GeneratedTokens != that1.GeneratedTokens {
		return false
	}
	return true
}
...
func (this *InstanceDesc) GoString() string {
	...
	s = append(s, "GeneratedTokens: "+fmt.Sprintf("%#v", this.GeneratedTokens)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *InstanceDesc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GeneratedTokens != 0 {
		i = encodeVarintRing(dAtA, i, uint64(m.GeneratedTokens))
		i--
		dAtA[i] = 0x48
	}
...
func (m *InstanceDesc) Size() (n int) {
	...
	if m.GeneratedTokens != 0 {
		n += 1 + sovRing(uint64(m.GeneratedTokens))
	}
	return n
}
...
func (this *InstanceDesc) String() string {
	...
	s := strings.Join([]string{`&InstanceDesc{`,
		...
		`GeneratedTokens:` + fmt.Sprintf("%v", this.GeneratedTokens) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *InstanceDesc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GeneratedTokens", wireType)
			}
			m.GeneratedTokens = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GeneratedTokens |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
